...
df = pd.read_excel('../data/raw/доля_зож.xls', header=1)
print(df)
...
df = pd.read_excel('../data/raw/доля_несовершеннолетних_участников_преступлений.xls', header=1)
...
df = pd.read_excel('../data/raw/количество_дипломов_на100тыс_человек.xlsx', header=0)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
print(df)
...
df = pd.read_excel('../data/raw/коэф_джини.xls', header=2)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/Население,_не_употребляющее_табачные_и_нетабачные_курительные_и.xlsx', header=3)
print(df)
...
df = pd.read_excel('../data/raw/преступление_лица.xls', header=1)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/преступления_алкогольное_опьянение.xls', header=1)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/преступления_женщины.xls', header=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/преступления_нарко_опьянение.xls', header=1)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/преступления_несовершеннолетние.xls', header=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/рейтинговый_балл_качества_жизни.xlsx', header=0)
df[df.columns[0]] = df[df.columns[0]].str.strip()
res = res.merge(df[[df.columns[0], 'среднее']], how='left', left_on='region', right_on=df.columns[0]).rename(columns={'среднее':'life_quality'})
res = res.drop(res.columns[len(res.columns)-2], axis = 1)
print(res)

df = pd.read_excel('../data/raw/численность_населения.xlsx')
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
df = pd.read_excel('../data/raw/Число_зарегистрированных_преступлений_в_России.xlsx', header=1)
df['mean'] = df.iloc[:, 1:].mean(axis=1)
df[df.columns[0]] = df[df.columns[0]].str.strip()
...
res.to_csv('../data/preprocessed/dataset.csv', index=False)